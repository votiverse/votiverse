...
export type { EngineOptions, CreateVotingEventParams, CreateIssueParams } from "./engine.js";

export { VotiverseEngine, createEngine } from "./engine.js";

// Re-export key types from sub-packages for consumer convenience
export type { GovernanceConfig, PresetName, ValidationResult } from "@votiverse/config";
...
export { InMemoryEventStore, timestamp } from "@votiverse/core";
...
export type { TallyResult, VoteRecord } from "@votiverse/voting";

export type { IdentityProvider } from "@votiverse/identity";
