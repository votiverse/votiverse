...
ALTER TABLE scoring_events ADD COLUMN original_closes_at TIMESTAMPTZ;
ALTER TABLE scoring_events ADD COLUMN start_as_draft BOOLEAN NOT NULL DEFAULT FALSE;
