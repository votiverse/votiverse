            ...
            {isMultiOption ? (
              <div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {choices.map((choice) => (
                    <button
                      ...
                      disabled={voting}
                      className="w-full px-4 py-3 text-sm font-semibold text-text-primary bg-surface-raised border border-border-default rounded-xl shadow-sm hover:bg-accent hover:text-text-on-accent hover:border-accent hover:shadow-md active:scale-[0.97] transition-all disabled:opacity-50"
                    >
                      {choice}
                    </button>
                  ))}
                ...
                <button
                  ...
                  disabled={voting}
                  className="w-full mt-2 px-4 py-3 text-sm font-semibold text-text-secondary bg-surface-raised border border-border-subtle rounded-xl hover:border-border-strong active:scale-[0.97] transition-all disabled:opacity-50"
                >
